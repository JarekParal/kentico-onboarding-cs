# kentico-onboarding-cs [![Build status](https://ci.appveyor.com/api/projects/status/hd46h13gmf8kkq9h?svg=true)](https://ci.appveyor.com/project/JarekParal/kentico-onboarding-cs)
